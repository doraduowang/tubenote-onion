...
const S = `
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  :root{
    ...
    --ink:#262628;--ink-2:#4a4850;--ink-3:#9a98a0;
    --accent:#D86072;--accent-bg:#fbeaed;--accent-dim:#f0b0bc;
    --lime:#D6DC82;--lime-bg:#f5f7dc;--lime-dim:#c8ce60;
    --lav:#C6C2F2;--lav-bg:#eeedfd;--lav-dim:#a8a4e8;
    --border:#e8e8e6;--border-s:#d4d4d0;
    --r:8px;--t:0.16s ease
  }
  .dark{
    --bg:#262628;--surface:#2e2c30;--surface-2:#343238;
    --ink:#FFF6EE;--ink-2:#c8c0b8;--ink-3:#787080;
    --accent:#D86072;--accent-bg:#3a1e24;--accent-dim:#6a2838;
    --lime:#D6DC82;--lime-bg:#2a2e18;--lime-dim:#8a9030;
    --lav:#C6C2F2;--lav-bg:#1e1c38;--lav-dim:#5a5888;
    --border:#3a3840;--border-s:#4e4c58
  }
  html,body{background:var(--bg);color:var(--ink);font-family:'DM Sans',sans-serif;font-size:14px;line-height:1.5;transition:background var(--t),color var(--t)}
  ...
  .brand{font-family:'Playfair Display',serif;font-size:22px;font-weight:700;color:var(--ink);letter-spacing:.01em}
  .brand em{color:var(--accent);font-style:italic;font-weight:400}
  .hdr-r{display:flex;align-items:center;gap:8px}
  .btn{display:inline-flex;align-items:center;gap:5px;padding:8px 15px;border-radius:var(--r);border:1.5px solid var(--border-s);background:var(--surface);color:var(--ink-2);font-family:'DM Sans',sans-serif;font-size:13px;font-weight:500;cursor:pointer;transition:all var(--t);white-space:nowrap;line-height:1}
  ...
  .url-box input{flex:1;background:none;border:none;outline:none;font-family:'DM Sans',sans-serif;font-size:13.5px;color:var(--ink);padding:11px 0}
  ...
  .vid-empty p{font-family:'Playfair Display',serif;font-size:17px;color:var(--ink-3);font-style:italic}
  ...
  .tag-pill{display:inline-flex;align-items:center;gap:4px;padding:3px 10px 3px 8px;border-radius:20px;background:var(--lime-bg);border:1.5px solid var(--lime-dim);color:var(--ink);font-size:12px;font-weight:500}
  ...
  .tag-input{padding:4px 8px;border:1.5px solid var(--border-s);border-right:none;border-radius:6px 0 0 6px;background:var(--surface-2);color:var(--ink);font-family:'DM Sans',sans-serif;font-size:12px;outline:none;width:110px;transition:border-color var(--t)}
  .tag-input:focus{border-color:var(--accent)}
  .tag-input::placeholder{color:var(--ink-3)}
  .tag-add-btn{padding:4px 10px;border:1.5px solid var(--border-s);border-left:none;border-radius:0 6px 6px 0;background:var(--surface-2);color:var(--ink-2);font-family:'DM Sans',sans-serif;font-size:12px;font-weight:500;cursor:pointer;transition:all var(--t)}
  ...
  .tl-progress{height:100%;background:var(--lime);border-radius:4px;pointer-events:none}
  .tl-dot{position:absolute;top:50%;transform:translate(-50%,-50%);width:12px;height:12px;border-radius:50%;background:var(--accent);opacity:.65;z-index:2;pointer-events:none}
  ...
  .tl-chip-ts{color:var(--accent);font-weight:600;font-size:11px;font-variant-numeric:tabular-nums}
  ...
  .tline.on{background:var(--lav-bg);border-left-color:var(--lav)}
  .tts{font-size:11px;font-weight:600;color:var(--accent);min-width:34px;padding-top:2px;font-variant-numeric:tabular-nums;flex-shrink:0}
  .ttxt{font-size:13.5px;color:var(--ink);line-height:1.65}
  .tw{border-radius:2px;padding:0 1px}
  .lang-sel{padding:5px 9px;border:1.5px solid var(--border-s);border-radius:6px;background:var(--surface);color:var(--ink-2);font-size:12px;font-family:'DM Sans',sans-serif;cursor:pointer;outline:none}
  ...
  .chatta{flex:1;padding:10px 12px;border:1.5px solid var(--border-s);border-radius:var(--r);outline:none;resize:none;font-family:'DM Sans',sans-serif;font-size:13px;color:var(--ink);background:var(--surface-2);transition:border-color var(--t);line-height:1.5}
  ...
  .nftab{padding:10px 14px;font-size:12px;font-weight:500;color:var(--ink-3);background:none;border:none;border-bottom:2px solid transparent;cursor:pointer;font-family:'DM Sans',sans-serif;white-space:nowrap;transition:color var(--t),border-color var(--t)}
  .nftab:hover{color:var(--ink-2)}
  .nftab.on{color:var(--accent);border-bottom-color:var(--accent)}
  ...
  .ncard-ts{color:var(--accent);font-weight:600;font-size:11px;margin-right:6px;font-variant-numeric:tabular-nums}
  .nadd{width:100%;padding:12px 14px;border:1.5px dashed var(--border-s);border-radius:var(--r);background:none;color:var(--ink-3);font-family:'DM Sans',sans-serif;font-size:13px;font-weight:500;cursor:pointer;text-align:left;transition:all var(--t);display:flex;align-items:center;gap:8px}
  ...
  .note-modal-title{font-family:'Playfair Display',serif;font-size:19px;color:var(--ink)}
  ...
  .note-title-input{width:100%;padding:10px 12px;border:1.5px solid var(--border-s);border-radius:var(--r);background:var(--surface-2);color:var(--ink);font-family:'DM Sans',sans-serif;font-size:13.5px;outline:none;transition:border-color var(--t)}
  .note-title-input:focus{border-color:var(--accent)}
  .note-title-input::placeholder{color:var(--ink-3)}
  .note-content-input{width:100%;padding:10px 12px;border:1.5px solid var(--border-s);border-radius:var(--r);background:var(--surface-2);color:var(--ink);font-family:'DM Sans',sans-serif;font-size:13.5px;outline:none;resize:vertical;min-height:100px;line-height:1.6;transition:border-color var(--t)}
  ...
  .note-folder-btn{padding:4px 12px;border-radius:20px;border:1.5px solid var(--border-s);background:var(--surface-2);color:var(--ink-3);font-size:12px;font-weight:500;cursor:pointer;font-family:'DM Sans',sans-serif;transition:all var(--t)}
  ...
  .stat-n{font-family:'Playfair Display',serif;font-size:28px;font-weight:500;color:var(--ink);line-height:1;margin-bottom:4px}
  ...
  .seg-btn{padding:5px 12px;font-size:12px;font-weight:500;color:var(--ink-3);background:none;border:none;cursor:pointer;font-family:'DM Sans',sans-serif;transition:all var(--t);display:flex;align-items:center;gap:4px}
  ...
  .hcard-tag{padding:2px 9px;border-radius:20px;font-size:11px;font-weight:500;background:var(--lav-bg);border:1.5px solid var(--lav-dim);color:var(--ink-2)}
  .badge{display:inline-flex;align-items:center;gap:3px;font-size:11px;color:var(--ink-3);margin-right:8px}
  .badge-g{color:#16a34a}
  ...
  .tag-fchip{padding:3px 11px;border-radius:20px;border:1.5px solid var(--border-s);background:var(--surface-2);color:var(--ink-3);font-size:11.5px;font-weight:500;cursor:pointer;font-family:'DM Sans',sans-serif;transition:all var(--t)}
  ...
  .acct-tab{padding:11px 16px;font-size:13px;font-weight:500;color:var(--ink-3);background:none;border:none;border-bottom:2.5px solid transparent;margin-bottom:-1.5px;cursor:pointer;font-family:'DM Sans',sans-serif;transition:all var(--t);display:flex;align-items:center;gap:6px;white-space:nowrap}
  ...
  .acct-item-ts{color:var(--accent);font-weight:600;font-variant-numeric:tabular-nums}
  ...
  .acct-panel-title{font-family:'Playfair Display',serif;font-size:20px;color:var(--ink);font-weight:500}
  ...
  .profile-empty p{font-family:'Playfair Display',serif;font-size:18px;color:var(--ink-3);font-style:italic;margin-bottom:16px}
  ...
  .def-modal-word{font-family:'Playfair Display',serif;font-size:22px;color:var(--ink)}
  ...
  .m-title{font-family:'Playfair Display',serif;font-size:27px;color:var(--ink);margin-bottom:4px}
  ...
  .fi{width:100%;padding:10px 13px;border:1.5px solid var(--border-s);border-radius:var(--r);background:var(--surface-2);color:var(--ink);font-family:'DM Sans',sans-serif;font-size:13.5px;outline:none;margin-bottom:14px;transition:border-color var(--t)}
  .fi:focus{border-color:var(--accent)}
  .m-link{display:block;text-align:center;font-size:12.5px;color:var(--accent);background:none;border:none;cursor:pointer;margin-top:10px;font-family:'DM Sans',sans-serif}
...
export default function App() {
  ...
  const [noteModal,setNoteModal] = useState(null); // {time, lineText, folder}
  ...
  const HistCard = ({h}) => (
    <div className="hcard" onClick={()=>jumpToVideo(h)} style={{cursor:"pointer"}}>
    ...
    <>
      ...
      <div className="app">
        ...
        <header className="hdr">
          <div className="brand">Tube<em>note</em></div>
          <div className="hdr-r">
            <button className="btn btn-icon" onClick={()=>setDark(d=>!d)}>{dark?Ico.sun:Ico.moon}</button>
            {user?(
              <button onClick={()=>setAcctOpen(true)}
                style={{display:"flex",alignItems:"center",gap:8,padding:"6px 12px 6px 6px",borderRadius:40,border:"1.5px solid var(--border-s)",background:"var(--surface)",cursor:"pointer",fontFamily:"'DM Sans',sans-serif",transition:"all var(--t)"}}
          ...
          {activeTab==="notes"&&(
            <>
              ...
              <div className="notes-body">
                {filteredNotes.length===0&&<div style={{padding:"24px 0",textAlign:"center"}}><p style={{fontSize:14,color:"var(--ink-3)",fontStyle:"italic",fontFamily:"'Playfair Display',serif"}}>No notes in this folder yet</p></div>}
                {filteredNotes.map(n=>(
                  <div key={n.id} className="ncard">
                    <div className="ncard-ico">{Ico.note}</div>
                    <div style={{flex:1}} onClick={()=>{const i=TRANSCRIPT.findIndex(l=>l.time>=n.time);if(i>=0){setActiveLine(i);setActiveTab("transcript");}}}>
                      <div className="ncard-title">{n.title}</div>
                      {n.content&&<div style={{fontSize:12.5,color:"var(--ink-3)",marginTop:3,lineHeight:1.5,whiteSpace:"pre-wrap"}}>{n.content}</div>}
                      <div className="ncard-meta" style={{marginTop:4}}><span className="ncard-ts">{fmt(n.time)}</span>{n.folder}</div>
                    </div>
                    <button style={{background:"none",border:"none",cursor:"pointer",color:"var(--ink-3)",padding:"2px 4px",transition:"color var(--t)"}}
                  ...
                  {acctTab==="notes"&&(()=>{
                    ...
                    return (
                      <div style={{paddingBottom:16}}>
                        ...
                        {visibleNotes.map(n=>(
                          <div key={n.id} className="acct-item" onClick={()=>{const vid=dedupedHistory.find(h=>h.id===n.video_id);if(vid)jumpToVideo(vid);}}>
                    ...
                    return (
                      <div style={{paddingBottom:16}}>
                        ...
                        {visibleBookmarks.map(b=>(
                          <div key={b.id} className="acct-item" onClick={()=>{const vid=dedupedHistory.find(h=>h.id===b.video_id);if(vid)jumpToVideo(vid);}}>
                            <div className="acct-item-thumb">
      ...
      {noteModal&&(
        <div className="overlay" onClick={()=>setNoteModal(null)}>
          <div className="note-modal" onClick={e=>e.stopPropagation()}>
            ...
            <div className="note-modal-ref">
              <span style={{color:"var(--accent)",fontWeight:600,fontStyle:"normal"}}>{fmt(noteModal.time)}</span>
              <span>"{noteModal.lineText.slice(0,80)}{noteModal.lineText.length>80?"…":""}"</span>
            </div>
            <div className="note-modal-body">
              <div>
                <div className="note-field-label">TITLE <span style={{fontWeight:400,color:"var(--ink-3)"}}>(optional — defaults to transcript line)</span></div>
              ...
              <div>
                ...
                <textarea className="note-content-input" value={noteModal.content} onChange={e=>setNoteModal(m=>({...m,content:e.target.value}))} placeholder="Write your thoughts, observations, questions…" autoFocus/>
              </div>
              <div>
            ...
            <div className="note-modal-foot">
              ...
              <button className="btn btn-accent" onClick={saveNote}>Save note</button>
            </div>
          </div>
        </div>
      )}
